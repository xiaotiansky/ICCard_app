...
public class DeviceInstallActivity extends Activity{
	...
	private void initView() {
		...
		topbarMid.setText(getString(R.string.device_repair_title));
		...
		topbarRight.setCompoundDrawables(drawable, null, null, null);
		...
		rightLay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(DeviceInstallActivity.this, AddInstallActivity.class);
