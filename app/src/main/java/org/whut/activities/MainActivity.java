...
public class MainActivity extends Activity{
	...
	private RelativeLayout rightTopbar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rightTopbar = (RelativeLayout) findViewById(R.id.tv_topbar_right_map_layout);
		rightTopbar.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				Intent mIntent = new Intent();
				mIntent.setClass(getApplication(), SettingActivity.class);
	...
	class GetConfigInstallTaskThread implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			synchronized (this) {
				inStream = MyClient.getInstance().DoGetConfigFile(UrlStrings.INSTALLATIONS_URL);
				try{
	...
	class GetConfigRepairTaskThread implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			synchronized (this) {
				inStream = MyClient.getInstance().DoGetConfigFile(UrlStrings.REPAIRS_URL);
				try{
